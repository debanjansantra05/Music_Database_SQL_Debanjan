...
-- in the city we made the money. Write a query that returns one city that has the highest 
...
-- best customer. Write a query that returns the person who has has spent the most money.
